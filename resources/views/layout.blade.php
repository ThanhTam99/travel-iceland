...
<body class="c-layout-header-fixed c-layout-header-mobile-fixed c-layout-header-topbar c-layout-header-topbar-collapse">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NGBFK5Z" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
            ...
            <div class="container">
                ...
                <nav class="c-top-menu c-pull-left">
                    <ul class="c-icons c-theme-ul">
                        <li>
                            <a href="https://www.facebook.com/CSKH-Tr%C3%B9m-C%C3%A1c-Game-Online-102414321166624/" target="_blank">
                    ...
                    <div class="c-brand c-pull-left">
                        <div style="margin: 0px;display: inline-block">
                            <a href="/" class="c-logo" alt="Shop bán nick game, acc game online avatar, đột kích – CF, liên minh huyền thoại lol , ngọc rồng, khí phách anh hùng - kpah giá rẻ, uy tín...">
                                <img height="35px" src="/storage/images/HYFiUkwC3Y_1560966469.jpg" alt="" class="c-desktop-logo">
                                <img height="29px" src="/storage/images/HYFiUkwC3Y_1560966469.jpg" alt="" class="c-desktop-logo-inverse">
                                <img height="35px" src="/storage/images/HYFiUkwC3Y_1560966469.jpg" alt="" class="c-mobile-logo"> </a>
                        </div>
                ...
                <div id="slide_banner" class="owl-carousel">
                    ...
                    <div class="item">
                        <a href="#" alt="{{$sli->title}}">
                            <img src="{{asset('uploads/slider/'.$sli->image)}}" width="100%" height="350px" alt="{{$sli->title}}">
                        </a>
                    </div>
                    @endforeach
                </div>
        ...
        <div class="c-prefooter">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div id="fb-root"></div>
                        <div class="fb-page" data-href="https://www.facebook.com/CSKH-Tr%C3%B9m-C%C3%A1c-Game-Online-102414321166624/" data-tabs="timeline" data-height="270" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                            <blockquote cite="https://www.facebook.com/CSKH-Tr%C3%B9m-C%C3%A1c-Game-Online-102414321166624/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/CSKH-Tr%C3%B9m-C%C3%A1c-Game-Online-102414321166624/">Nick.vn</a>
                            </blockquote>
                        </div>
                    </div>
                </div>
