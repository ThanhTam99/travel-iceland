        ...
        <div class="container">
            <div class="row">
                <div class="alert alert-info" role="alert">
                    ...
                    <p></p>
                    <p><span style="color:#e74c3c"><strong>Danh muc dich vu</strong></span><strong>Dịch vụ bán skin và tướng giá rẻ game LIÊN MINH TỐC CHIẾN&nbsp;</strong></p>
                    <p></p>
                </div>
            ...
            <div class="c-content-client-logos-slider-1  c-bordered" data-slider="owl">
                ...
                <div class="c-content-title-1">
                    <h3 class="c-center c-font-uppercase c-font-bold">Danh muc {{$slug}}</h3>
                    ...
                    <div class="col-sm-3 col-xs-6 p-5">
                        <div class="classWithPad">
                            <div class="news_image">
                                <img style="position: absolute;max-width: 79px;height: auto;top: -5px;right: -6px;z-index: 1122;" src="images/giam.png" />
                                <a href="/danh-muc/danh-muc-game-free-fire" title="Danh Mục Game Free Fire" class="">
                                    <img src="{{asset('frontend/images/vHPm7XyQah_1623147701.jpg')}}" alt="Danh Mục Game Free Fire"></a>
                            </div>
