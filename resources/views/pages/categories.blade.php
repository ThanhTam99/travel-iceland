        ...
        <div class="container">
            <div class="row">
                <div class="alert alert-info" role="alert">
                    ...
                    <p></p>
                    <p><span style="color:#e74c3c"><strong>Danh muc game lien quan. </strong></span><strong>Danh muc bán skin và tướng giá rẻ game LIÊN MINH TỐC CHIẾN&nbsp;</strong></p>
                    <p></p>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="custom72 view">
                                            <a href="{{route('dichvucon','nick-lien-quan')}}" title="Danh Mục Game Liên Quân">
                                                &nbsp;
                                                <style type="text/css">
                                                    .custom72 {
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="custom74 view">
                                            <a href="{{route('danhmuccon','cay-thue-lien-quan')}}" class="" title="Danh Mục Game Free Fire">
                                                &nbsp;
                                                <style type="text/css">
                                                    .custom74 {
                                                        border: none !important;
